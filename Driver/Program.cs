...
internal class Program
{
    ...
    {
        var DEV002 = new DbServer("DEV002", Environment.GetEnvironmentVariable("localDb"));
        var Corewell = new DbServer("Corewell", Environment.GetEnvironmentVariable("localDb1"));
